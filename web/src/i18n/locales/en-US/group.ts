  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        ...
        appendLocalAccount: 'Append local account',
        appendLocalAccountSucceeded: 'Appended the current local account',
        appendLocalAccountAlreadyPresent: 'The current local account already exists, skipped',
        appendLocalAccountNoLocalAccount: 'No local primary account found',
        appendLocalAccountFailed: 'Unable to append the local account',
