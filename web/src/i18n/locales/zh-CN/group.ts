  ...
  group: {
    ...
    credentials: {
      ...
      subscription: {
        ...
        appendLocalAccount: '追加本机账号',
        appendLocalAccountSucceeded: '已追加本机当前账号',
        appendLocalAccountAlreadyPresent: '本机当前账号已在其余额行中，未重复追加',
        appendLocalAccountNoLocalAccount: '本机未发现本地主账号',
        appendLocalAccountFailed: '无法追加本机账号',
